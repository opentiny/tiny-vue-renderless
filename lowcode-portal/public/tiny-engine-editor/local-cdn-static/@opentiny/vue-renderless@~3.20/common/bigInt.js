...
export { BigIntDecimal, NumberDecimal, equalsDecimal, getMiniDecimal, getNumberPrecision, isE, lessEquals, num2str, setDecimalClass, supportBigInt, toFixed, trimNumber, validateNumber };