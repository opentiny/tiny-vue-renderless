...
import { isNumber, isObject, isDate, typeOf } from './../../type.js';
const emailReg1 = '^(([^<>()\\[\\]\\\\.,;:\\s@"]+(\\.[^<>()\\[\\]\\\\.,;:\\s@"]+)*)|(".+"))';
...
function type_default(rule, value, source, errors, options) {
  ...
  const custom = ["array", "acceptImg", "acceptFile", "date", "digits", "dateTime", "dateYM", "dateYMD", "email", "float", "fileSize", "hex", "integer", "longDateTime", "method", "number", "object", "regexp", "speczh", "specialch", "specialch2", "time", "version", "url"];
