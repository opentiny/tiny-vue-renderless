...
function buildColidsByVisibleColumn({
  $table,
  bodyRowCount,
  bodyTrs,
  colids,
...
function createExcelFromDom($table, opts) {
  ...
  const {
    ...
    bodyTrBgcArr,
    footerTrBgc
  } = getTableAttr($table, headerWrapper, bodyTrs);
