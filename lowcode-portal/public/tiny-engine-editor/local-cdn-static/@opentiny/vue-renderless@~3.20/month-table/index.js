...
import { hasClass } from './../common/deps/dom.js';
import { range as rangeDate, getDayCountOfMonth, nextDate } from './../common/deps/date-util.js';
...
const cellMatchesDate = props => (cell, date) => {
...
const getMonthOfCell = props => month => new Date(props.date.getFullYear(), month, 1);
export { cellMatchesDate, clearDate, datesInMonth, getCellStyle, getMonthOfCell, getMonthTimestamp, getRows, handleMonthTableClick, handleMouseMove, markRange, watchDate };