...
![](md-only-prefix/img/AI/image21.png)

**想获取以上 access_token 值，请看最后标题的“使用前先获取 access_token，拿文心一言举例”**

2、在`tiny-engine-webservice/app/lib/enum.ts`文件变更如下

![](md-only-prefix/img/AI/image22.png)

### 前端代码改动

在`tiny-engine/packages/plugins/robot/src/js/robotSetting.js`文件改动如下

![](md-only-prefix/img/AI/image23.png)

- ### 前后端代码启动后使用 AI 插件

1、点击 AI 对话框

![](md-only-prefix/img/AI/image24.png)

2、在对话框里选择使用的 AI 模型
![](md-only-prefix/img/AI/image25.png)

3、输入问题，即能成功回答

![](md-only-prefix/img/AI/image26.png)
...
![](md-only-prefix/img/AI/image29.png)

查看 access_token 值，下图可看到在线运行成功，成功获取 token 值

![](md-only-prefix/img/AI/image30.png)

3、调用 API 接口

![](md-only-prefix/img/AI/image31.png)
![](md-only-prefix/img/AI/image32.png)
