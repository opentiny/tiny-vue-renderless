...
![通过样式面板设置样式](md-only-prefix/img/docimg/styleSettingStatic.png)

![通过样式面板配置样式](md-only-prefix/img/docimg/styleSettingNew.gif)
...
![样式面板设置样式结果1](md-only-prefix/img/docimg/styleSettingResult1.png)
![样式面板设置样式结果2](md-only-prefix/img/docimg/styleSettingResult2.png)
...
![设置行内样式](md-only-prefix/img/docimg/inlineStyleSettingNew.gif)

如上动图设置成功之后，相当于做了以下操作：组件 schema 属性中，props 属性的 style 绑定了我们手动修改的样式

![设置行内样式结果](md-only-prefix/img/docimg/inlineSettingResultNew.png)

### 编写全局样式

点击编写全局样式，可以直接声明多条CSS样式或其他媒体查询的样式，然后通过组件的 class 或者 id 进行绑定

![通过编写代码设置样式](md-only-prefix/img/docimg/editGlobalStyleNew.gif)
...
![类名新增](md-only-prefix/img/docimg/setClassNameStatic.png)

![类名新增](md-only-prefix/img/docimg/setClassNameNew.gif)
...
![类名修改动图](md-only-prefix/img/docimg/editClassNameNew.gif)
![类名修改示意图](md-only-prefix/img/docimg/editClassNameStatic.png)
...
![类名删除](md-only-prefix/img/docimg/deleteClassNameNew.gif)
...
![已有类名选择](md-only-prefix/img/docimg/selectClassNameNew.gif)
...
![编辑 hover 状态](md-only-prefix/img/docimg/setStyleHoverNew.gif)
...
![行内样式绑定变量](md-only-prefix/img/docimg/inlineStyleBindVar.gif)
