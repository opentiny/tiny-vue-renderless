...
![mysql官网下载](md-only-prefix/img/docimg/backend_deploy_1.png)

根据操作系统选择相应版本下载

![mysql官网下载](md-only-prefix/img/docimg/backend_deploy_2.png)
...
![windows环境](md-only-prefix/img/docimg/backend_deploy_4.png)
...
![启动脚本](md-only-prefix/img/docimg/backend_deploy_8.png)
...
![启动脚本](md-only-prefix/img/docimg/backend_deploy_7.png)
...
![TinyEngine](md-only-prefix/img/docimg/backend_deploy_5.png)
...
![TinyEngine](md-only-prefix/img/docimg/backend_deploy_6.png)


初次启动后，需要进行一次物料编译初始化编译，前后端同步，具体请查看 [此文档](portal-only-prefix/help-center/course/dev/56)
...
![image](md-only-prefix/img/docimg/backend_deploy_9.png)

在 `app` 目录下新建`view` 文件夹， 再将`public` 文件夹中的 .html 文件放入`view` 目录中：

![image](md-only-prefix/img/docimg/backend_deploy_10.png)
