...
在[出码功能简介与使用](/#/help-center/course/dev/7342098765432108)章节中，我们知道了出码的核心是将符合TinyEngine协议规范的 schema 转换成符合语义的、高质量可读的代码。但是，工程化代码（基础项目代码）、代码风格、具体 schema to code 具体细节等等的情形可能每个团队都有不同的选择，所以也就诞生了自定义出码的需求。下面，我们针对“基于官方出码能力增加出码插件”以及“自定义插件完成 schema to code 的转换”两种情形进行介绍。
...
![vue模板编译流程](md-only-prefix/img/docimg/vuetemplate.png)

TinyEngine 出码整体流程：

![TinyEngine出码流程](md-only-prefix/img/docimg/TinyEngineSchem2Code.png)
...
更多信息请查看 [如何自定义出码插件](/#/help-center/course/dev/2103941249230714) 以及 [官方出码能力API](/#/help-center/course/dev/6812432179376041) 章节

## 自定义出码 package 完成 schema to code 的转换

假如应用出码目标非 vue 技术栈，或者目标出码与官方出码差异太大。那么，我们可以借鉴官方出码的方式，完全自定义自身的出码。本质上只要符合输入输出的相关规范即可。

![自定义出码包](md-only-prefix/img/docimg/customGenCodePlugin.png)
