...
详细 api 说明，可查看 [官方出码能力API](/#/help-center/course/dev/6812432179376041)

## 增加增量插件

在 [如何自定义出码](/#/help-center/course/dev/2345678901234567)章节中，我们描述了如何替换官方出码插件，但是如果我们并不需要替换官方插件，而是增加插件，则可以往指定的出码阶段增加插件，例如：
...
- 对官方当前出码结果进行局部调整，可使用 pluginConfig 往页面出码进行传参，实现局部调整的结果。具体可查看[自定义页面出码插件](/#/help-center/course/dev/8765432109876543)章节
