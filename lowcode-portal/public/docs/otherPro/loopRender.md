...
2. 添加变量，例如loop.isLogin。
   ...
   **图 1**  添加变量
   ...
   ![](md-only-prefix/img/figures/addVar-17.png "addVar-17")
...
5. 选择绑定的变量，单击“确定”。
   ...
   **图 2**  绑定变量
   ...
   ![](md-only-prefix/img/figures/bindVariable-18.png "绑定变量-18")
...
6. 为展示内容添加变量，默认为item。
   ...
   **图 3**  添加变量
   ![](md-only-prefix/img/figures/addVar-19.png "绑定变量-19")

   **图 4**  查看渲染效果

   ![](md-only-prefix/img/figures/viewRender.png "查看渲染效果")
