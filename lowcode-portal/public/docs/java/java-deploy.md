...
![](md-only-prefix/img/java/image1.png)
...
![](md-only-prefix/img/java/image2.png)
...
![](md-only-prefix/img/java/image3.png)
3、解压并安装 maven
...
- 将 maven 移动到喜欢的位置，例如 tinyengine/maven,进入 tinyengine/maven 路径下执行`sudo mv /root/apache-maven-3.9.9 .`
  ...
  ![](md-only-prefix/img/java/image4.png)
...
![](md-only-prefix/img/java/image5.png)
