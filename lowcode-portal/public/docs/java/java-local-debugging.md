...
![](md-only-prefix/img/java/image36.png)

**步骤二 在步骤一新建的连接上右键选择“新建数据库”->输入数据库名称**

如下图所示

![](md-only-prefix/img/java/image37.png)
...
![](md-only-prefix/img/java/image38.png)
...
![](md-only-prefix/img/java/image39.png)
...
![](md-only-prefix/img/java/image40.png)

前后端启动成功后页面会自动弹出，如下可看连接数据库数据接口调通能返回正常数据

![](md-only-prefix/img/java/image41.png)
...
![](md-only-prefix/img/java/image42.png)
