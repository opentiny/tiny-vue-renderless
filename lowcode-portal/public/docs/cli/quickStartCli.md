...
![lowcode-designer](md-only-prefix/img/docimg/tiny-engine-cli.png)
...
![打开默认设计器](md-only-prefix/img/docimg/tiny-engine-cli-open.png)
...
![cli-create-plugin](md-only-prefix/img/docimg/cli-create-plugin.png)
...
![cli-plugin-open](md-only-prefix/img/docimg/cli-plugin-open.png)
