...
const getToolbarTips = (t) => [
  ...
  { Choice: '.ql-header .ql-picker-label', title: t('ui.richText.pickerLabel') },
  { Choice: '.ql-header .ql-picker-item[data-value="1"]', title: t('ui.richText.headerPicker1') },
  { Choice: '.ql-header .ql-picker-item[data-value="2"]', title: t('ui.richText.headerPicker2') },
  { Choice: '.ql-header .ql-picker-item[data-value="3"]', title: t('ui.richText.headerPicker3') },
  { Choice: '.ql-header .ql-picker-item[data-value="4"]', title: t('ui.richText.headerPicker4') },
  { Choice: '.ql-header .ql-picker-item[data-value="5"]', title: t('ui.richText.headerPicker5') },
  { Choice: '.ql-header .ql-picker-item[data-value="6"]', title: t('ui.richText.headerPicker6') },
  { Choice: '.ql-header .ql-picker-item:last-child', title: t('ui.richText.normal') },
  { Choice: '.ql-size .ql-picker-item[data-value="small"]', title: t('ui.richText.sizeSmall') },
  { Choice: '.ql-size .ql-picker-item[data-value="large"]', title: t('ui.richText.sizeLarge') },
  { Choice: '.ql-size .ql-picker-item[data-value="huge"]', title: t('ui.richText.sizeHuge') },
  { Choice: '.ql-size .ql-picker-item:nth-child(2)', title: t('ui.richText.normal') },
  { Choice: '.ql-align .ql-picker-item:first-child', title: t('ui.richText.alignPicker1') },
  { Choice: '.ql-align .ql-picker-item[data-value="center"]', title: t('ui.richText.alignPicker2') },
  { Choice: '.ql-align .ql-picker-item[data-value="right"]', title: t('ui.richText.alignPicker3') },
  { Choice: '.ql-align .ql-picker-item[data-value="justify"]', title: t('ui.richText.alignPicker4') },
  { Choice: '.ql-script[value="sub"]', title: t('ui.richText.subScript') },
  { Choice: '.ql-script[value="super"]', title: t('ui.richText.superScript') },
  { Choice: '.ql-direction[value="rtl"]', title: t('ui.richText.directionRTL') },
