...
export const fetchDefaultData = ({ emit, fetchArea, nextTick, props, refs, state }) => () => {
  let parent = ''
...
export const getRegion = ({ emit, fetchArea, nextTick, props, refs, state }) => (value) => {
  state.jcr = value
...
export const getRep = ({ emit, fetchArea, nextTick, props, refs, state }) => (value) => {
  state.region = value
...
export const getOffice = ({ emit, fetchArea, nextTick, props, refs, state }) => (value) => {
  state.rep = value
...
export const changeOffice = ({ emit, state }) => (value) => {
  state.office = value
  emit('update:modelValue', [state.jcr, state.region, state.rep, state.office])
}

export const beforeMount = ({ api, props }) => () => {
