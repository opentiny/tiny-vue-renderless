...
export const getTextStyle = ({ props, state }) => () => {
...
export const handelKey = ({ emit, props, state }) => (event) => {
...
export const selectValue = ({ emit, props, state }) => (value) => {
  if (props.disabled) {
    return
  }
...
export const setCurrentValue = ({ constants: { RATENODECLS, DECIMALCLS, ICON_PREFIXCLS }, props, state, parent, api }) => ({ event, item }) => {
  if (props.disabled) {
    return
  }
...
export const resetCurrentValue = ({ props, state }) => () => {
  if (props.disabled) {
    return
  }
...
export const showDecimalIcon = ({ props, state }) => (item) => {
...
export const getIconStyle = ({ api, props, state }) => (item) => {
...
export const computedVoidClass = ({ props, state }) => (props.disabled ? state.classMap.disabledVoidClass : state.classMap.voidClass)
