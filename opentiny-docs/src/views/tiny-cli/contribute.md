...
你可以添加官方小助手微信 opentiny-official，加入技术交流群参与讨论

当你亲自使用 TinyCLI，并参与多次以上形式的贡献，对 TinyCLI 逐渐熟悉之后，可以尝试做一些更有挑战的事情，比如：
...
除了参与 TinyCLI 项目，你还可以贡献新的 TinyCLI 套件与插件到 [`tiny-cli-extensions`](https://github.com/opentiny/tiny-cli-extensions)，未包含在[内置插件](https://github.com/opentiny/tiny-cli/tree/dev/packages/plugins)与[内置套件](https://github.com/opentiny/tiny-cli/tree/dev/packages/toolkits)中的其他拓展需要提交到 [`tiny-cli-extensions`](https://github.com/opentiny/tiny-cli-extensions) 代码库中，相关要求与规范与当前项目一致。


<h2 id='issue'>提交 Issue</h2>
...
- Clone 个人仓库到本地
- 在 TinyCLI 根目录下运行 npm init, 安装依赖
