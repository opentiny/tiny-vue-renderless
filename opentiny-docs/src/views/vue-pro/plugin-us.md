...
- [Object storage service OBS](/vue-pro/docs/advanced/plugin#obs)

- [Virtual Private Cloud Service VPC](/vue-pro/docs/advanced/plugin#private)

- [EIP Service EIP](/vue-pro/docs/advanced/plugin#EIP)

- [Cloud Database Service RDS](/vue-pro/docs/advanced/plugin#RDS)

- [FunctionGraph Service FunctionGraph](/vue-pro/docs/advanced/plugin#FunctionGraph)

- [API Gateway Service APIG](/vue-pro/docs/advanced/plugin#APIG)
...
> After this command is executed, the `TinyCLI` will check whether the plug-in is installed on your computer. If the plug-in is not installed, the system starts to install the plug-in. After the installation is successful, all cloud services supported by the plug-in are listed, more [see](/vue-pro/docs/advanced/plugin#cloudbu)。

<h2 id='list'>Command List</h2>

- [tiny hwc](/vue-pro/docs/advanced/plugin#cloudbu)

- [tiny hwc configure](/vue-pro/docs/advanced/plugin#configure)

- [tiny hwc obs](/vue-pro/docs/advanced/plugin#obs)

- [tiny hwc vpc](/vue-pro/docs/advanced/plugin#private)

- [tiny hwc eip](/vue-pro/docs/advanced/plugin#EIP)

- [tiny hwc mysql](/vue-pro/docs/advanced/plugin#RDS)

- [tiny hwc fg](/vue-pro/docs/advanced/plugin#FunctionGraph)

- [tiny hwc apig](/vue-pro/docs/advanced/plugin#APIG)
...
<h3 id="cloudbu">2. <span>Cloud Service List</span></h3>
...
<h4>Command for Synchronizing HUAWEI CLOUD VPC Resources</h4>
...
<h4>Commands for creating a HUAWEI CLOUD VPC resource</h4>
...
2022-xx-xx xx:xx:xx [aio-plugin-hwc-vpc]: The subnet is created successfully！
```
...
<h4>Synchronizing HUAWEI CLOUD EIP Resources</h4>
...
<h4>Command for creating HUAWEI CLOUD EIP resources</h4>
...
<h4>Synchronizing RDS Resources on HUAWEI CLOUD</h4>
...
<h4>Commands for creating HUAWEI CLOUD RDS resources</h4>

```bash
> tiny hwc mysql create
--------------------Start to create the database instance, follow the instructions below-------------------------
...
<h4>Commands for binding or unbinding an EIP from an RDS resource</h4>
...
<h4>Command for Synchronizing FunctionGraph Resources on HUAWEI CLOUD</h4>
...
<h4>Commands for creating HUAWEI CLOUD FunctionGraph resources</h4>
...
<h4>Updated HUAWEI CLOUD FunctionGraph resource commands to support code and dependencies</h4>
...
<h4>Commands for creating or updating a HUAWEI CLOUD FuncitonGraph resource dependency package</h4>
...
<h4>This command is used to synchronize HUAWEI CLOUD APIG resource groups, you must select a group for APIG resources</h4>
...
<h4>Command for creating a HUAWEI CLOUD APIG resource group</h4>

```bash
> tiny hwc apig group create
--------------------Start creating the API Gateway group, Perform the following operations--------------------
...
<h4>Synchronizing HUAWEI CLOUD APIG resources</h4>
...
<h4>Commands for creating HUAWEI CLOUD APIG resources</h4>
...
<h4 id='publish'>Publishing HUAWEI CLOUD APIG resource commands</h4>
