...
快速开始基于`云服务插件`，请移步`云服务插件`[准备工作](/ng-pro/docs/advanced/hwcPlugin#work)章节。
...
推荐使用<a href="/tiny-cli/home" target="_blank" rel="noopener noreferrer">`TinyCLI`</a>开发工具来初始化一个Angular应用。
...
<h3 id='install'>2. 安装<a href="/ng-pro/docs/advanced/hwcPlugin">云服务插件</a>并初始化</h3>
...
<h3 id='library'>3. 安装<a href="/ng-pro/docs/advanced/hwcClient#setplugin">云服务客户端库</a>并初始化</h3>
...
创建函数工作流实例涉及到创建[`FunctionGraph`](/ng-pro/docs/advanced/hwcPlugin#FunctionGraph)实例、编写函数代码和关联函数代码。

#### 4.1 创建[`FunctionGraph`](/ng-pro/docs/advanced/hwcPlugin#FunctionGraph)实例
...
> [点击此处](/ng-pro/docs/advanced/hwcClient#apigClient)，查看`exec`方法参数说明。
