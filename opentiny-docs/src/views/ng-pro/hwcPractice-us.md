...
The best practice demonstrates typical add, delete, query, and modify operations to familiarize developers with the serverless development mode and code path`src/app/pages/contracts`。
![ng-preview.png](/src/assets/images/ng-pro/ng-preview.png)

<h2 id='Preparations'>Preparations</h2>

est practices are based on`cloud service plug-ins`，please move`cloud service plug-ins`[`preparations`](/ng-pro/docs/advanced/hwcPlugin#work)。

<h2 id='step'>Steps</h2>

<h3 id='createapp'>1. creating an application</h3>

Recommended<a href="/tiny-cli/home" target="_blank" rel="noopener noreferrer">`TinyCLI`</a>Develop tools to initialize a Angular application.
...
<h3 id='installcloud'>2. install<a href="/ng-pro/docs/advanced/hwcPlugin">cloud service plug-ins</a>and initialized</h3>
...
<h3 id='installhwcClient'>3. Install<a href="/ng-pro/docs/advanced/hwcClient">cloud service client library</a>and initialized</h3>
...
Creating a database instance involves[`RDS`](/ng-pro/docs/advanced/hwcPlugin#RDS)、[`VPC`](/ng-pro/docs/advanced/hwcPlugin#private) and[`EIP`](/ng-pro/docs/advanced/hwcPlugin#EIP).
...
#### 4.3 create[`EIP`](/ng-pro/docs/advanced/hwcPlugin#EIP)instance
...
#### 4.4 create[`RDS`](/ng-pro/docs/advanced/hwcPlugin#RDS)instance and association[`EIP`](/ng-pro/docs/advanced/hwcPlugin#EIP)instance
...
#### 4.5 association[`EIP`](/ng-pro/docs/advanced/hwcPlugin#EIP)instance
...
Creating a function workflow instance involves creating[`FunctionGraph`](/ng-pro/docs/advanced/hwcPlugin#FunctionGraph)instances and functions<a href="https://support.huaweicloud.com/usermanual-functiongraph/functiongraph_01_0391.html" target="_blank" rel="noopener noreferrer">dependency package management</a>、function code management.

#### 5.1 create[`FunctionGraph`](/ng-pro/docs/advanced/hwcPlugin#FunctionGraph)instance
...
> In addition to the preceding `EIP` + `Security Group` mode, you can also set `Permissions for FunctionGraph` + `VPC Access` to directly access services on the public network.  
> <a href="https://support.huaweicloud.com/usermanual-functiongraph/functiongraph_01_0920.html" target="_blank" rel="noopener noreferrer">Set Permission Access Function Workflow</a>  
> <a href="https://support.huaweicloud.com/usermanual-functiongraph/functiongraph_01_0222.html" target="_blank" rel="noopener noreferrer">Setting an Agency for VPC Management Permissions</a>
...
The sample code demonstrates the adding, deleting, querying, and modifying logic of the `MySql` database，[Sample Code Download](/public/assets/sample-code/groupService.zip)，decompress the package to the command execution directory.
...
Creating an API Gateway instance involves creating a group and creating an API Gateway instance[`APIG`](/ng-pro/docs/advanced/hwcPlugin#APIG)instance.
...
#### 6.2 create[`APIG`](/ng-pro/docs/advanced/hwcPlugin#APIG)instance
...
> During the creation process, the user is asked to select a function workflow instance in step 5.

 <h3 id='makecase'>7.API Gateway Instance Called by Page</h3>

For details, see section[Effect Preview](/ng-pro/docs/advanced/hwcPractice#Preview)by now, the best practices are complete. Developers can improve and expand their applications based on the best practices.
